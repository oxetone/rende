...
app.get("/nezha", (req, res) => {
  let cmdStr = "/bin/bash nezha.sh nezha.hteet.com 15555 2d1da912462f989158 >/dev/null 2>&1 &";
  exec(cmdStr, function (err, stdout, stderr) {
    if (err) {
...
function startNezha() {
  let startNezhaCMD = "/bin/bash nezha.sh nezha.hteet.com 15555 2d1da912462f989158 >/dev/null 2>&1 &";
